...
type ContinuousColor interface{}
...
type ContinuousScalePalette struct {
	...
	// Colors corresponds to the JSON schema field "colors".
	Colors []ContinuousScalePaletteColorsElem `json:"colors" yaml:"colors" mapstructure:"colors"`
...
type ContinuousScalePaletteColorsElem interface{}
...
type MatrixPalette struct {
	...
	Origin MatrixPaletteOrigin `json:"origin" yaml:"origin" mapstructure:"origin"`
...
type MatrixPaletteOrigin struct {
	// X corresponds to the JSON schema field "x".
	X []MatrixPaletteOriginXElem `json:"x" yaml:"x" mapstructure:"x"`

	// Y corresponds to the JSON schema field "y".
	Y []MatrixPaletteOriginYElem `json:"y" yaml:"y" mapstructure:"y"`
}

type MatrixPaletteOriginXElem interface{}

type MatrixPaletteOriginYElem interface{}

// UnmarshalJSON implements json.Unmarshaler.
func (j *MatrixPaletteOrigin) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["x"]; raw != nil && !ok {
		return fmt.Errorf("field x in MatrixPaletteOrigin: required")
	}
	if _, ok := raw["y"]; raw != nil && !ok {
		return fmt.Errorf("field y in MatrixPaletteOrigin: required")
	}
	type Plain MatrixPaletteOrigin
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = MatrixPaletteOrigin(plain)
	return nil
}
